...
import { Home, Users, FileText, ShieldCheck, ClipboardList, UserMinus, LogOut } from 'lucide-react';
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-bone-200 bg-white">
        <div className="p-6">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-ink-soft to-ink flex items-center justify-center text-bone-50 ring-1 ring-inset ring-white/10 shadow-sm">
